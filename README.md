...
> |---|---|---|---|---|
> | Data stays local | ✅ | ❌ | ❌ | Optional |
> | Zero infrastructure | ✅ | ❌ | ❌ | ❌ |
> | No code changes | ✅ | ✅ | ❌ | ✅ |
> | Streaming body capture | ✅ (256KB cap) | Partial | Partial | Partial |
> | TTFT metric | ✅ | ❌ | ❌ | ❌ |
> | Cost tracking | ✅ | ✅ | ✅ | ✅ |
> | Cache-aware cost | ✅ | Partial | ❌ | ❌ |
> | Field-level redaction | ✅ | ❌ | ❌ | Partial |
> | Budget alerting | ✅ | Paid | Paid | Paid |
> | Web dashboard | ✅ (local) | Cloud | Cloud | Cloud |
> | Full-text search | ✅ | ❌ | Partial | Partial |
> | CI cost gate | ✅ | ❌ | ❌ | ❌ |
> | Prometheus / OTel | ✅ | ❌ | Partial | Partial |
